    ...
    <div class="col-md-12 " style="padding-top: 20px;">
        <table class="form" width="100%" border="0" cellspacing="2" cellpadding="3">
            ...
            <tr>
                ...
                <td class="fieldarea">
                    <input id="category" name="category" onchange="applyDesk(this.value)"
                           value="{$article->category->title}" class="form-control">
                </td>
            </tr>
            <tr>
                <td width="15%" class="fieldlabel">Описание категории</td>
                <td class="fieldarea">
                    <input type="text" name="desk" id="desk" value="{$article->category->description}"
                           class="form-control">
                </td>
            </tr>
                    ...
                    <select name="articlesFilter[]" class="selectpicker" data-width="420px" data-actions-box="true"
                        ...
                        {foreach $admins as $admin}
                            <option value="{$admin->id}"
                                    {if $admin->id|array_key_exists:$admins_allow}
                                        selected
                                    {/if}
        ...
        <textarea name="article" rows="20" class="form-control tinymce">{$article->text}</textarea>
